...
const filterOptions: Option[] = [
  { id: 1, name: 'General', type: 'commissionType' },
  { id: 2, name: 'Custom', type: 'commissionType' },
  { id: 3, name: 'Commercial', type: 'providerType' },
  { id: 4, name: 'Residential', type: 'providerType' },
];
